...
public class Client {
  ...
  public Client() {
    this(
        ...
        Constants.DISPATCHER_MAX_REQUESTS,
        Constants.DISPATCHER_MAX_REQUESTS_PER_HOST,
        Constants.CONNECTION_POOL_MAX_IDLE_COUNT,
        Constants.CONNECTION_POOL_MAX_IDLE_MINUTES);
  }
  ...
  public Client(Configuration cfg) {
    this(
        ...
        cfg.readTimeout,
        cfg.writeTimeout,
        cfg.dispatcherMaxRequests,
        cfg.dispatcherMaxRequestsPerHost,
  ...
  public Client(
    ...
    ConnectionPool connectionPool =
        new ConnectionPool(
            connectionPoolMaxIdleCount, connectionPoolMaxIdleMinutes, TimeUnit.MINUTES);
  ...
  private static RequestBody create(
      final MediaType contentType, final byte[] content, final int offset, final int size) {
   ...
   * @throws QiniuException 请求失败
   */
  public Response get(String url, Map<String, String> headers) throws QiniuException {
   ...
   * @throws QiniuException 请求失败
   */
  public Response delete(String url, Map<String, String> headers) throws QiniuException {
   ...
   * @throws QiniuException 请求失败
   */
  public Response put(String url, byte[] body, Map<String, String> headers) throws QiniuException {
    return put(url, body, headers, CONTENT_TYPE_JSON);
  }
   ...
   * @throws QiniuException 请求失败
   */
  public Response put(String url, String body, Map<String, String> headers) throws QiniuException {
    return put(url, StringUtils.utf8Bytes(body), headers, CONTENT_TYPE_JSON);
  }
  ...
  public Response put(String url, Map<String, String> params, Map<String, String> headers)
    ...
    params.forEach(f::add);
    return put(url, f.build(), headers);
  }

  public Response put(String url, byte[] body, Map<String, String> headers, String contentType)
      throws QiniuException {
    RequestBody rbody;
  ...
  private Response put(String url, RequestBody body, Map<String, String> headers)
      throws QiniuException {
   ...
   * @throws QiniuException 请求失败
   */
  public Response post(String url, byte[] body, Map<String, String> headers) throws QiniuException {
    return post(url, body, headers, CONTENT_TYPE_JSON);
  }

  public Response post(String url, String body, Map<String, String> headers) throws QiniuException {
    return post(url, StringUtils.utf8Bytes(body), headers, CONTENT_TYPE_JSON);
  }

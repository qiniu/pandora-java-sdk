...
public final class Response {
  ...
  public static Response create(okhttp3.Response response, String address, double duration) {
    ...
    byte[] body = null;
    if (ctype(response).equals(Client.CONTENT_TYPE_JSON)) {
      try {
  ...
  public static Response createError(
      okhttp3.Response response, String address, double duration, String error) {
    if (response == null) {
  ...
  public boolean isJson() {
    return contentType().equals(Client.CONTENT_TYPE_JSON);
  }
